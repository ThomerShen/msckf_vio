...
void MsckfVio::publish(const ros::Time& time) {
  ...
  curr_pose.pose.orientation = odom_msg.pose.pose.orientation;
  curr_pose.header = odom_msg.header;

  global_path.header = odom_msg.header;
  global_path.poses.push_back(curr_pose);
